...
<nav className="bg-white border-orange-700">
    <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl px-4 md:px-6 py-2.5">
        <a href="https://flowbite.com" className="flex items-center">
            <img src="https://i.postimg.cc/fWvBRRvt/demaklogo.png" className="mr-0 h-12 sm:h-7" alt="Demakventures Logo" />
            <span className="self-center text-orange-900 text-2xl font-semibold whitespace-nowrap ">
                <span className='text-4xl text-orange-600'>D</span>emak <span className='text-orange-900 text-xl'>
                    <span className='text-4xl text-orange-600'>V</span>entures</span>
            </span>
        </a>
    ...
    <div id="mega-menu-full-image-dropdown" className="mt-1 bg-white border-gray-200 shadow-sm border-y dark:bg-gray-800 dark:border-gray-600">
        <div className="grid py-5 px-4 mx-auto max-w-screen-xl text-sm text-gray-500 dark:text-gray-400 md:grid-cols-3 md:px-6">
            ...
            <a href="#" className="p-8 text-left bg-local bg-gray-500 bg-center bg-no-repeat bg-cover rounded-lg bg-blend-multiply hover:bg-blend-soft-light dark:hover:bg-blend-darken" src>
                <p className="mb-5 max-w-xl font-extrabold tracking-tight leading-tight text-white">Preview the new Flowbite dashboard navigation.</p>
...
// demakventures text darkmode  dark:border-gray-600 dark:bg-gray-900
